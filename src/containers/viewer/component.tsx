...
import { recordBookProgress } from "../../utils/progression/xpStats";
...
class Viewer extends React.Component<ViewerProps, ViewerState> {
  ...
  applyHighlightTypography = () => {
    const styleId = "kookit-highlight-typography";
    const css = `
      .kookit-highlight-text,
      .kookit-note,
      mark.kookit-highlight-text {
  ...
  handleRenderBook = async () => {
    ...
    BookUtil.fetchBook(
      ...
      // renderTo resolves only after the renderer has attached its first page.
      // Waiting for the next frame prevents an empty window without using a timer.
      requestAnimationFrame(this.props.handleContentReady);
  ...
  handleLocation = () => {
    ...
    recordBookProgress(this.props.currentBook, position);
  };
  handleBindGesture = () => {
