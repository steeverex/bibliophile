    ...
    return optionList.map((item) => {
      return (
        <div
          ...
          key={item.propName}
        >
          <div className="setting-dialog-new-title setting-toggle-row" key={item.title}>
            <span style={{ width: "calc(100% - 100px)" }}>
              <Trans>{item.title}</Trans>
            </span>

            <Ripple><span
              className={`single-control-switch ${this.state[item.propName] ? "is-on" : "is-off"}`}
              onClick={() => {
  ...
  render() {
    return (
      <>
        ...
        <div className="setting-dialog-new-title setting-toggle-row">
        ...
        <div className="setting-select-block">
        <div className="setting-dialog-new-title setting-select-row">
